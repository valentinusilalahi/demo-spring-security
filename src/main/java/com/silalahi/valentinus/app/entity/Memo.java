...
public class Memo implements Serializable {
	...
	private static final long serialVersionUID = 8379938075644576813L;
	...
	public static Memo of(Long id, String title, String description) {
		return Memo.builder().id(id).title(title).description(description).done(false).updated(LocalDateTime.now())
				.build();
	}
